...
function coronaBuddyWritePopupTextArea(data) {
    if (coronaBuddyGetPopupTextArea()) {
        ...
        for (var _i = 0; _i < _a2.length; _i++) {
            _r.push(_f2(_a2[_i], _i, _a2));
        }

        coronaBuddyGetPopupTextArea().value = _r.join(", ");
    }
}
function templateDOMElement(_a) {
    var e_1, _b;
    var _c = _a.tag,
        tag = _c === void 0 ? null : _c,
        _d = _a.classList,
        classList = _d === void 0 ? null : _d,
        _e = _a.innerHTML,
        innerHTML = _e === void 0 ? null : _e,
        _f = _a.id,
        id = _f === void 0 ? null : _f,
        _g = _a.style,
        style = _g === void 0 ? null : _g;
